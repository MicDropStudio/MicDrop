...
export default function ContactForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Opzionale: Resetta i campi del form dopo l'invio così l'utente trova il form pulito se torna indietro
    setName('');
    setEmail('');
    setPhone('');
    setService('ALL');
          ...
          <div className="lg:col-span-5 flex flex-col justify-between gap-12">
            <div>
              ...
              <p className="text-gray-400 text-sm sm:text-base leading-relaxed mb-8">
                Compila il form per generare la tua mail precompilata!
              </p>
          ...
          <div className="lg:col-span-7">
            <div className="bg-dark-card border border-dark-border rounded-2xl p-6 md:p-8 relative overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <button type="submit" className="w-full py-4 bg-brand-orange text-white font-bold uppercase rounded-xl flex items-center justify-center gap-2 cursor-pointer hover:bg-brand-orange/90 transition-colors">
                  Invia Messaggio
                </button>
              </form>
            </div>
